    ...
    <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 max-w-sm w-full rounded-[2.5rem] overflow-hidden shadow-2xl p-6 text-center space-y-6 animate-in zoom-in-95 text-slate-800 dark:text-slate-200">
        ...
        <div className="space-y-1.5">
          <span className="text-[10px] uppercase font-bold tracking-widest text-blue-600 dark:text-blue-400 font-mono block">
            Incoming Voice Call...
          </span>
        ...
        <div className="flex gap-4 justify-center items-center py-2">
          ...
          <button
            onClick={onReject}
            className="w-14 h-14 bg-rose-600 hover:bg-rose-700 text-white rounded-full flex items-center justify-center shadow-lg hover:shadow-rose-600/30 hover:scale-105 active:scale-95 transition-all outline-none"
            title="Decline Call"
          >
          ...
          <button
            onClick={onAccept}
            className="w-14 h-14 bg-emerald-600 hover:bg-emerald-700 text-white rounded-full flex items-center justify-center shadow-lg hover:shadow-emerald-600/30 hover:scale-105 active:scale-95 transition-all outline-none"
            title="Answer Call"
          >
