...
export function CallTimeline({ timeline }: CallTimelineProps) {
  return (
    <div className="space-y-2">
      ...
      <div className="bg-slate-950/80 rounded-xl p-3 border border-slate-850 h-32 overflow-y-auto space-y-1.5 font-mono text-[9px] text-slate-350 leading-relaxed scrollbar-thin">
