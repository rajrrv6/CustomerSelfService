    ...
    <div className="bg-purple-100 dark:bg-purple-950/20 border border-purple-200 dark:border-purple-900 rounded-2xl p-4 flex gap-3 text-purple-700 dark:text-purple-400 animate-in slide-in-from-top-4 duration-250">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex justify-between items-start">
          <span className="text-[11px] uppercase font-bold tracking-wider font-mono">Supervisor Live Whisper:</span>
          {onClose && (
        ...
        <p className="mt-1 leading-normal font-normal text-[13px]">
          &quot;{whisper}&quot;
        </p>
        {onApplyWhisper && (
          <div className="mt-2.5 flex gap-2">
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-1 bg-purple-600 hover:bg-purple-700 text-white rounded-lg text-[10px] font-bold transition-all shadow-sm"
            >
