...
export function Customer360Drawer({ profile }: Customer360DrawerProps) {
  ...
  return (
    <div className="h-full flex flex-col justify-between overflow-y-auto p-5 space-y-5 bg-slate-50/90 dark:bg-slate-950/20 text-xs font-semibold text-slate-700 dark:text-slate-200">
      {/* Header */}
      <div>
        <h3 className="font-bold text-xs text-slate-500 dark:text-slate-400 uppercase font-mono tracking-wider">Customer 360 View</h3>
      </div>
      ...
      <div className="text-center space-y-2 pb-4 border-b border-slate-200 dark:border-slate-800/80">
        ...
        <div>
          ...
          <span className="text-[10px] text-slate-500 dark:text-slate-400 block font-mono mt-1">{profile.email}</span>
          <span className="text-[10px] text-slate-500 dark:text-slate-400 block font-mono">{profile.phone}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-2 text-[10px]">
        <div className="p-2.5 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 text-left">
          <span className="text-slate-500 dark:text-slate-400 font-bold block uppercase font-mono text-[8px]">NPS Score</span>
          <span className="text-sm font-bold text-slate-800 dark:text-white mt-0.5 block font-mono">{profile.npsScore}/10</span>
        </div>
        <div className="p-2.5 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 text-left">
          <span className="text-slate-500 dark:text-slate-400 font-bold block uppercase font-mono text-[8px]">Churn Risk</span>
      ...
      <div className="space-y-3 pt-3 border-t border-slate-200 dark:border-slate-800/80">
        <div className="flex justify-between items-center text-xs">
          <span className="text-slate-500 dark:text-slate-400">VIP Support Tier</span>
        ...
        <div className="flex justify-between items-center text-xs">
          <span className="text-slate-500 dark:text-slate-400">Total Customer Spend</span>
