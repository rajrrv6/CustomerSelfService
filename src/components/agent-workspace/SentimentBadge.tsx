...
export function SentimentBadge({ sentiment }: SentimentBadgeProps) {
  const configs = {
    positive: {
      bg: 'bg-emerald-100 dark:bg-emerald-950/30 text-emerald-800 dark:text-emerald-400 border-emerald-200 dark:border-emerald-900/50',
      label: 'POSITIVE',
      icon: Smile
    },
    neutral: {
    ...
    negative: {
      bg: 'bg-rose-100 dark:bg-rose-950/30 text-rose-800 dark:text-rose-400 border-rose-200 dark:border-rose-900/50',
      label: 'NEGATIVE',
      icon: Frown
    }
  };
