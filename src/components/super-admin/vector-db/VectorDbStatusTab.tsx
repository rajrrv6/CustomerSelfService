...
export function VectorDbStatusTab() {
  ...
  return (
    <div className="space-y-6">
      <SectionHeader
        title="Vector DB Cluster Status"
        description="Real-time status of RAG index clusters hosted on Pinecone Enterprise and pgvector."
        action={headerAction}
      />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <OperationalCard hoverEffect={true} className="p-6 space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-xs font-semibold text-slate-600 dark:text-slate-400">
              <span>Cluster Storage Limit</span>
              <span className="text-slate-800 dark:text-slate-200">41.2% Used</span>
            </div>
        ...
        <OperationalCard hoverEffect={true} className="p-6 space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-xs font-semibold text-slate-600 dark:text-slate-400">
              <span>Cluster Storage Limit</span>
              <span className="text-slate-800 dark:text-slate-200">14.8% Used</span>
            </div>
            <div className="h-2 bg-slate-100 dark:bg-slate-850 rounded-full overflow-hidden">
