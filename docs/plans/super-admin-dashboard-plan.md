...
| **Infra** | Vector DB cluster status (12)<br>Knowledge connector registry (13) | 🟡 Partial | Vector DB status (12) is implemented. Knowledge connector registry (13) Notion and Drive credentials panels are missing. |
